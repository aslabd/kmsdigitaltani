				...
				if (err) {
					...
					(async() => {
						try {
							...
							// Ambil jumlah ikuti
							temp.jumlah.ikuti.call = await fetch(configuration.host + '/user/profil/ikuti/' + user + '/cek');
							...
							temp.jumlah.pengikut.call = await fetch(configuration.host + '/user/profil/pengikut/' + user + '/cek');
